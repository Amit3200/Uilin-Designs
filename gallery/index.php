...
include("conn.php");
$sql1 = "SELECT image, user_name FROM uploads u JOIN user_data ud where u.user_id = ud.user_id";
...
<body>
  <nav class="nav" style="font-family: 'QuickSand';font-weight: 100;">
    <div class="nav-bar">
      <a class="nav-link linkerhere" href="">Home</a>
      <a class="nav-link linkerhere" href="../login/login.php">Profile</a>
      <a class="nav-link linkerhere" href="../login/about.php">About</a>
      <a class="nav-link linkerhere" href="../login/login.php">Login/SignUp</a>
      <span class="nav-slider"></span>
    </div>
  </nav>
  <section id="top12er">
    <h1 style="font-size: 3.2rem;color:white;">Today's Design</h1>
    <span class="iop" style="font-family: 0.2rem;color:white;">
